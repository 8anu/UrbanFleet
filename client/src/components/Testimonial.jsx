...
const Testimonial = () => {
    ...
    const testimonials = [
        ...
        {    name: "Siddhant",
             ...
             testimonial: "I've rented cars from different platform but the experience with UrbanFleet is most amazing"
        },
        ...
        { 
            ...
            image: assets.testimonial_image_1,          
            testimonial: "Well, on point service and i can say i'm not disappointed" 
        }
    ];
  ...
  return (
    ...
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            ...
            <Title title = "What Our Customers Say" subtitle="Discover why discerning travelers choose UrbanFleet for thier accomodation across nation." />
