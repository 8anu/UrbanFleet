  ...
  return (
    <div>
      ...
      <div className='flex flex-col items-center py-20 bg-light max-md:px-4'>
        <Title title='Available Cars' subtitle='Browse our selection of vehicles
      ...
      w-full h-12 rounded-full shadow'>
        ...
        <input onClick={(e)=> setInput(e.target.value)} value={input} type="text" placeholder='Search by name, model, or features' 
        className='w-full h-full outline-non text-gray-500'/>
