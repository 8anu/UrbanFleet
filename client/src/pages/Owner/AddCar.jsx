...
const AddCar = () => {
  ...
  return (
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <Title title='Add New Car' subtitle='Fll in the details to list a new car for booking,, including pricing, availability, and car specifications.' />
      ...
      className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        {/*Car brand and details */}

        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Brand</label>
            <input type='text' placeholder='e.g. Hyundai, Toyota, BMW......' required
         ...
         <div className='flex flex-col w-full'>
            <label>Model</label>
            <input type='text' placeholder='e.g. Innova, Swift, Verna......' required
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
           ...
           <div className='flex flex-col w-full'>
            ...
            <input type='number' placeholder='1800' required
           ...
           <div className='flex flex-col w-full'>
            ...
            <select onChange={e=> setCar({...car, category: e.target.value})} value={car.category} className='px-3 py-2 mt-1 border-borderColor'>
        ...
        {/* Location and Description */}
          ...
          <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} type='number' placeholder='write about you vehicle......' required
